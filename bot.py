...
KB_FILE    = os.path.join(os.path.dirname(__file__), "data", "knowledge_base_transport.json")
INDEX_FILE = os.path.join(os.path.dirname(__file__), "data", "embeddings_index.pkl")
